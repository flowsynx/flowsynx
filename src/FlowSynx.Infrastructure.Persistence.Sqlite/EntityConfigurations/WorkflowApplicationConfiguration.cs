...
public class WorkflowApplicationConfiguration : IEntityTypeConfiguration<WorkflowApplication>
{
    public void Configure(EntityTypeBuilder<WorkflowApplication> builder)
    {
        ...
        var specConverter = new ValueConverter<WorkflowApplicationSpecification, string>(
            v => JsonSerializer.Serialize(v, jsonOptions),
            v => JsonSerializer.Deserialize<WorkflowApplicationSpecification>(v, jsonOptions)
        );
        ...
        builder.Property(g => g.SharedContext)
            .HasColumnType("TEXT")
            .HasConversion(
                v => JsonSerializer.Serialize(v, jsonOptions),
                v => JsonSerializer.Deserialize<Dictionary<string, object>>(v, jsonOptions) ?? new Dictionary<string, object>())
