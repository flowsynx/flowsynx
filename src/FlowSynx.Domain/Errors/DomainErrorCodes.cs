...
public static class DomainErrorCodes
{
    ...
    public static readonly ErrorCode GeneGenerationRequired = new(100_103, ErrorCategory.Domain);
    public static readonly ErrorCode GenePhenotypicRequired = new(100_104, ErrorCategory.Domain);
    public static readonly ErrorCode GeneAnnotationRequired = new(100_105, ErrorCategory.Domain);
    public static readonly ErrorCode GeneExpressedProteinRequired = new(100_106, ErrorCategory.Domain);
