...
internal class GoogleDriveBrowser : IGoogleDriveBrowser, IDisposable
{
    ...
    public GoogleDriveBrowser(ILogger logger, DriveService client, GoogleDriveSpecifications? specifications)
    {
