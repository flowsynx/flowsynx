...
internal class GoogleCloudBrowser : IGoogleCloudBrowser, IDisposable
{
    private readonly ILogger _logger;
    private readonly StorageClient _client;
    private readonly GoogleCloudSpecifications? _specifications;

    public GoogleCloudBrowser(ILogger logger, StorageClient client, GoogleCloudSpecifications? specifications)
    {
        _logger = logger;
        _client = client;
